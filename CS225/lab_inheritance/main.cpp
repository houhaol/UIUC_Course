...
int main()
{
    ...
    rectangle_center.setX(rectangle_center.x() + rectangle_width);
    ...
    Drawable** drawables = new Drawable*[num_drawables]; // drawables store array of Drawable pointers type address
