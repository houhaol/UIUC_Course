...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/media/storage2/dominic/data',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='XRAY',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='XRAY',
...
parser.add_argument('--test_every', type=int, default=1000, 
                    help='do test per every N batches')  #Test per BATCH
parser.add_argument('--epochs', type=int, default=100,     
                    help='number of epochs to train')    #Train for number of EPOCHS
